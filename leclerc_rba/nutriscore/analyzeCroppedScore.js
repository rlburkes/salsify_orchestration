...
1. Locate the Nutri-Score label by identifying the "NUTRI-SCORE" text along with the color-coded rating letters (A in green, B in yellowish-green, C in yellow, D in orange, and E in red).
2. Identify which letter (A, B, C, D, or E) is most prominent/enlarged, representing the Nutri-Score value. It is also the value that is most 'filled' in with white, other letters will appear more affected by their background.
...
const imgProps = {
"cropped": [context.cropped_score.transformedUrl]
};
Object.entries(imgProps).forEach(entry => {
